...
public class CancelBooking extends AppCompatActivity
{
    ...
    private static final String apiurl="https://icarparkbackup1.000webhostapp.com/androidapp/qrcode.php";
    private static final String apiurlcancelbooking="https://icarparkbackup1.000webhostapp.com/androidapp/cancelbooking.php";
    String qryString;
