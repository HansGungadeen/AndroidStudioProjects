...
public class NewBooking extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String url = "https://icarparkbackup1.000webhostapp.com/androidapp/location.php";
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id)
    {
        if (adapterView.getId() == R.id.spinnerLocation)
        {
            ...
            String url = "https://icarparkbackup1.000webhostapp.com/androidapp/slots.php?building_location=" + selectedLocation;
