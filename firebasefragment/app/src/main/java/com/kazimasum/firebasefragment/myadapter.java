...
public class myadapter extends FirebaseRecyclerAdapter<model,myadapter.myviewholder>
{
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull final model model) {
        holder.emailtext.setText(model.getComment());
      ...
      Glide.with(holder.img1.getContext()).load(model.getPurl()).into(holder.img1);
              ...
              holder.img1.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                      ...
                      activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper,new descfragment(model.getName(),model.getCourse(),model.getComment(),model.getPurl())).addToBackStack(null).commit();
                  }
              });
    }
