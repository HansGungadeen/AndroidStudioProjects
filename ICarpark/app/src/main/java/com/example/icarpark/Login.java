...
public class Login extends AppCompatActivity {
    ...
    private static final String apiurl="https://icarpark.000webhostapp.com/androidapp/login.php";
    ...
    public void login_process(View view)
    {
        ...
        Toast.makeText(getApplicationContext(), "Logging. Please Wait", Toast.LENGTH_SHORT).show();
